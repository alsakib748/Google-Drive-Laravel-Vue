...
class FileController extends Controller
{
    public function myFiles(Request $request, string $folder = null)
    {
        ...
        // If a folder path was provided, load that folder for the current user.
        // Otherwise fall back to the root folder so $folder is always a File instance
        // (prevents "Attempt to read property 'id' on null").
        if ($folder) {
            $folder = File::query()
    ...
    /**
     * Return the root folder for the authenticated user. Create it if it doesn't exist.
     *
    ...
    // ...removed duplicate getRoot method...
